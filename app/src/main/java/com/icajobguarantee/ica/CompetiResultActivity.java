...
public class CompetiResultActivity extends AppCompatActivity implements WebInterface {

    Button go_to_home, go_to_next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_competi_result);
...
//        });
    ...
    public void init() {
        ...
        go_to_next = (Button) findViewById(R.id.go_to_next);
...
//        result_status = (TextView) findViewById(R.id.result_status);
    ...
    private void getData(){
        ...
        WebServiceController wc = new WebServiceController(CompetiResultActivity.this,CompetiResultActivity.this);
    ...
    public void getResponse(String response, int flag) {
        if (flag == 0) {
            try {
                ...
                String result_text = string1 + ">=<" + string2 + ">=<" + string3 + ">=<" + string4 + ">=<" + string5 + ">=<" + string6 + ">=<" + rank + ">=<" + rank_calculation + ">=<" + string7;
