...
public class CourseAddMoreActivity extends AppCompatActivity implements WebInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_add_more);
    ...
    private void getData(){
        ...
        WebServiceController wc = new WebServiceController(CourseAddMoreActivity.this,CourseAddMoreActivity.this);
            ...
            try {
                ...
                if (jsonArray.length()>0) {
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (course_selected.equalsIgnoreCase("0")) {
                    ...
                    androidGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view,
                            ...
                            builder = new AlertDialog.Builder(CourseAddMoreActivity.this);
