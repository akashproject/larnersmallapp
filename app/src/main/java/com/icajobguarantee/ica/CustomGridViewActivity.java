...
public class CustomGridViewActivity extends BaseAdapter {
    ...
    public CustomGridViewActivity(Context context, ArrayList<String> gridViewId, ArrayList<String> gridViewString, ArrayList<String> gridViewImageId, ArrayList<String> gridViewSelected) {
        mContext = context;
...
//            gridViewAndroid = new View(mContext);
            gridViewAndroid = inflater.inflate(R.layout.course_grid_list, parent, false);
        } else {
