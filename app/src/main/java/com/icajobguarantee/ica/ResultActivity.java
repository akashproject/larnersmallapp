...
public class ResultActivity extends AppCompatActivity implements WebInterface {
...
//        result_status = (TextView) findViewById(R.id.result_status);
    ...
    private void getData(){
        ...
        WebServiceController wc = new WebServiceController(ResultActivity.this,ResultActivity.this);
