...
public class VersionActivity extends AppCompatActivity implements WebInterface  {
    TextView textView;
    public String qfor;
    ...
    private void getData(){
        ...
        WebServiceController wc = new WebServiceController(VersionActivity.this,VersionActivity.this);
